...
```{r}
# lm for EstPound and MileLocation
...
```{r}
# multiple regression for EstPound, MileLocation, Acreage, EstSeconds
...
```{r}
# mult reg for EstPound, Type, HwyLocation, MileLocation
...
```{r}
# mult reg for EstPound, LocalPeaches, MileLocation
